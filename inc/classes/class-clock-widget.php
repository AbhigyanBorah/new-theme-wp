...
class Clock_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        parent::__construct(
            ...
            'Clock', // Name
            array('description' => __('A Clock Widget', "Abhigyan's Theme")) // Args
        );
    }
    /**
...
<?php
    ...
    public function form($instance)
    {
        if (isset($instance['title'])) {
            ...
            $title = __('Clock', "Abhigyan's Theme");
        }
    ?>
<p>
    <label for="<?php echo $this->get_field_name('title'); ?>"><?php _e('Title:', "Abhigyan's Theme"); ?></label>
